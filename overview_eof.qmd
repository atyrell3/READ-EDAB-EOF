...
The harvested species with the lowest trophic level is ocean quahog, with a trophic level of `r lower_tl`. The harvested species with the highest trophic level is goosefish, with a trophic level of `r upper_tl`. If we average the two, we get a mean trophic level of `r mean_tl`. Let's try applying these ballpark numbers in our analyses below.
